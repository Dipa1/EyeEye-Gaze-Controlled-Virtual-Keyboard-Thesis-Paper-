...
board = np.zeros((800, 800 ), np.uint8)
board[:] = 255
...
keys_set_1 = {0: "0", 1: "1", 2: "2", 3: "3", 4: "4",
              ...
              15: "Z", 16: "X", 17: "C", 18: "_", 19: "DL",
              20: ",", 21: ".", 22: "?", 23: "!", 24: "<"}

keys_set_2 = {0: "5", 1: "6", 2: "7", 3: "8", 4: "9",
              5: "Y", 6: "U", 7: "I", 8: "O", 9: "P",
              10: "H", 11: "J", 12: "K", 13: "L", 14: "V",
              15: "B", 16: "N", 17: "M", 18: "_", 19: "DL",
              20: "*", 21: "+", 22: "-", 23: "/", 24: "<"}
...
def draw_menu():
    ...
    cv2.line(keyboard, (int(cols/2) - int(th_lines/2), 0),(int(cols/2) - int(th_lines/2), rows),
             (51, 51, 51), th_lines)
    cv2.putText(keyboard, "LEFT", (60, 200), font, 4, (255, 255, 255), 5)
    cv2.putText(keyboard, "RIGHT", (60 + int(cols/2), 200), font, 4, (255, 255, 255), 5)
...
def get_gaze_ratio(eye_points, facial_landmarks):
    ...
    _, threshold_eye = cv2.threshold(gray_eye, 65, 255, cv2.THRESH_BINARY)
...
while True:
    ...
    for face in faces:
        ...
        if select_keyboard_menu is True:
            ...
            if .90<gaze_ratio <= 1.2:
                keyboard_selected = "right"
                keyboard_selection_frames += 1
                # If Kept gaze on one side more than 25 frames, move to keyboard
                if keyboard_selection_frames == 25:
            ...
            if blinking_ratio > 5:
                ...
                if blinking_frames == frames_to_blink:
                    if active_letter != "<" and active_letter != "_" and active_letter != "DL":
                        text += active_letter
                        sound.play()
                    if active_letter == "_":
                        text += " "
    ...
    cv2.putText(board, text, (100, 100), font, 6, 0, 3)
